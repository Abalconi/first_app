...
cert_ia_url = (
    "https://raw.githubusercontent.com/Abalconi/first_app/main/assets/cert_ia.pdf"
)
cert_django_url = (
    "https://raw.githubusercontent.com/Abalconi/first_app/main/assets/cert_django.pdf"
)
...
for curso in cursos:
    ...
    if "certificación" in curso:
        st.markdown(
            f'<a href="{curso["certificación"]}" target="_blank" rel="noopener noreferrer">Ver Certificación</a>',
